...
# def resampling_20(folder, file_template, file_resize):
#     upscale_factor = 2
...
#     if a > 0:
#         res_plus = np.zeros((resample.shape[0]+1,resample.shape[1]))
#         res_plus[:,:-1] = resample
    
#     if a < 0:
#         res_del = np.delete(resample,0,0)
    
#     if b > 0:
#         res_plus = np.zeros((resample.shape[0],resample.shape[1]+1))
